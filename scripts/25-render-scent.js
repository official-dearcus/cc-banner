/* CC 배너 제너레이터 — 25-render-scent
   ...
   → 기존 제품군은 아무 것도 안 바뀐다. */
      ...
      const SCENT = {
        detail: {
          W: 860, H: 1298,
          pat: { x: -18, y: 35, w: 895, h: 1719 },
          deco: { x: 20, y: 91 },
          img: { x: 60, y: 201, w: 740, h: 920 },
          ...
          poly: { x: 796, y: 693, w: 10, h: 296 },
          code: { x: 822, y: 934, h: 37, size: 28, rot: 90 },
          stamp: { x: 662.17, y: 1057.26, w: 123.88, h: 89.56 },
          foot: { x: 39, y: 1052, h: 74, size: 28, ls: -2, lines: 2 },
          tag: { x: 420, y: 1090, h: 32, size: 24, ls: -2 },
        },
        feed: {
          W: 1080, H: 1350,
